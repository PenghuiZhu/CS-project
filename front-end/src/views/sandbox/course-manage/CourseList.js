...
import CourseForm from "../../../components/course-manage/CourseForm";
...
export default function CourseList(){
    ...
    return (
        <div>
            ...
            />
            <Modal title="Add Course" open={isModalOpen} onOk={handleOk} onCancel={handleCancel}
                   okText="Submit" cancelText="Cancel">
                <CourseForm ref={addForm}></CourseForm>
            </Modal>

            <Modal title="Edit Course" open={isUpdateOpen} onOk={updateFormOK} onCancel={updateCancel}
                   okText="Update" cancelText="Cancel">
                <CourseForm ref={updateForm}></CourseForm>
            </Modal>
        </div>
    )
}